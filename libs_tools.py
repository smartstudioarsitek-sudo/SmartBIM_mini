...
def tool_cek_baja_wf(mu_kNm, bentang_m):
    ...
    """
    # Memanggil Logic dari libs_baja.py
...
def tool_hitung_pondasi(beban_pu, lebar_m):
    ...
    """
    # Memanggil Logic dari libs_pondasi.py
    engine = fdn.Foundation_Engine(150.0) # Daya dukung asumsi 150 kN/m2
...
def tool_estimasi_biaya(volume_beton):
    ...
    """
    # Memanggil Logic dari libs_ahsp.py
